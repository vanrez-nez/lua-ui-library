...
return {
    ...
    fillGradient = Rule.custom(GraphicsValidation.validate_gradient, { optional = true }),
    fillTexture = Rule.custom(GraphicsValidation.validate_texture_or_sprite_source, { optional = true }),
    ...
    strokeColor = Rule.optional(CustomRules.color()),
