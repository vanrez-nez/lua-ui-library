...
`src/lua/demos/` contains small, isolated Love2D apps whose only purpose is to teach
...
- shared helper utilities in `src/lua/demos/common/screen_helper.lua`
...
[src/lua/demos/common/demo_base.lua](common/demo_base.lua).

Use shared infrastructure from `src/lua/demos/common/`:
...
When using `src/lua/demos/common/screen_helper.lua`, the execution-file build callback is
