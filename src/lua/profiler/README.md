...
```sh
PROFILE=1 PROFILE_FEATURES=all love src/lua
```
...
```sh
PROFILE=1 PROFILE_TARGETS=lib/ui/core/container.lua,lib/ui/scene love src/lua
```

### Speedscope output

```sh
PROFILE=1 PROFILE_FORMAT=speedscope love src/lua
```
